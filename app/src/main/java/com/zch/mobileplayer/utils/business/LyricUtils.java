package com.zch.mobileplayer.utils.business;
        ...
        if (file == null || !file.exists()) {
            ...
            Collections.sort(lyrics, new Comparator<Lyric>() {
                ...
                public int compare(Lyric lhs, Lyric rhs) {
                    if (lhs.timePoiont < rhs.timePoiont) {
                        return -1;
                    }
                    if (lhs.timePoiont > rhs.timePoiont) {
                        return 1;
            ...
            for (int i = 0; i < lyrics.size(); i++) {
                ...
                if (i + 1 < lyrics.size()) {
                    ...
                    oneLyric.sleepTime = twoLyric.timePoiont - oneLyric.timePoiont;
                }
            }
        }
